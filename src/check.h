...
#ifndef __CHECK_H__ #define __CHECK_H__
...
/*
 * Check chess pieces against established rules.
 *
 * If the move cannot be satisfied, the function will return with -1.
 *
 * If any other error occurs, the function will return 1 and errno 1.
 * TODO: Finish this comment.
 */
int8_t check(int8_t old_row_pos,          /* Current row position of the piece to be moved */
             int8_t old_column_pos,       /* Current column position of the piece to be moved */
             int8_t new_row_pos,          /* The row position of the piece to be moved */
             int8_t new_column_pos,       /* The column position of the piece to be moved */
             chess_board *original_board, /* Current chess board structure */
